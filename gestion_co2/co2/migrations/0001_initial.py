# Generated by Django 3.0.2 on 2020-01-06 22:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TipoSistemaInteligente',
            fields=[
                ('tipo', models.AutoField(primary_key=True, serialize=False)),
                ('nombre', models.TextField()),
                ('factor', models.IntegerField(choices=[(1, 'Positivo'), (-1, 'Negativo')])),
            ],
        ),
        migrations.CreateModel(
            name='TiposVehiculo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='co2.TipoSistemaInteligente')),
            ],
        ),
        migrations.CreateModel(
            name='Empleado',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mes', models.IntegerField()),
                ('year', models.IntegerField()),
                ('id_sistema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='co2.SistemaInteligente')),
            ],
        ),
    ]
